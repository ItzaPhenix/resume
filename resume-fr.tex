...
\begin{itemize}
    \item \textbf{Specialisation}: (GISTRE) Génie Informatique des Systèmes
...
\begin{itemize}
\item \textbf{Teaching:} Shell, C, C++, Java, SQL et modèles de données pour
    300 étudiants
\end{itemize}
}
